							...
							<div class="wgs-content">
								<div class="wgs-post-single">
									...
									<div class="wgs-post-entry">
										...
										<span class="wgs-post-meta">December 19, 2018</span>
									</div>
								</div>
								<div class="wgs-post-single">
									<div class="wgs-post-thumb">
						...
						<div class="wgs-footer wgs-contact">
							...
							<div class="wgs-content">
								<ul class="wgs-contact-list">
									<li><span class="pe pe-7s-map-marker"></span>217 Summit Road <br/>Abuja, Nigeria</li>
									<li><span class="pe pe-7s-call"></span>Telephone : (234) 4567 8910 <br/>Telephone : (234) 1234 5678</li>
									<li><span class="pe pe-7s-global"></span>Email : <a href="mailto:info@sitename.com">info@rri.com</a> <br/>Web : <a href="http://example.com">www.example.com</a></li>
								</ul>
							</div>
						</div>
						<!-- End Widget -->
			...
			<div class="container">
				<div class="row">
					<div class="site-copy col-sm-7">
						<p>Copyright &copy; 2018 RoyalRealInvestment. by <a href="https://greysoft.com.ng">Greysoft Technologies</a></p>
					</div>
